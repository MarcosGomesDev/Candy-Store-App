...
import { SafeAreaView, View, Text, StyleSheet, Modal, TouchableOpacity, Alert } from 'react-native';
                ...
                {({values, errors, touched, isSubmitting, handleChange, handleBlur, handleSubmit}) => {
                    ...
                    return (
                        <FormContainer style={{height: 400}}>
                            ...
                            >
                                <Text style={
                                    {color: 'rgba(118, 92, 174, 1)', fontSize: 17, textDecorationLine: 'underline'}
